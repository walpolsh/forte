...
export const Frets = windowWidth =>
  windowWidth < 1000 ? ["", "0", 1, "", 3, "", 5, "", 7, "", 9, "", "", 12] : ["", "0", 1, "", 3, "", 5, "", 7, "", 9, "", "", 12, "", "", 15, "", 17, "", 19, "", "", 22, "", 24];
...
export const MajorObj = {
  Ionian: {
    ...
    name: "Major",
    chords: majorChords[0]
  },
  Dorian: {
    formula: ["1", "2", "b3", "4", "5", "6", "b7"],
    degree: [0, 2, 3, 5, 7, 9, 10],
    name: "Dorian",
    chords: majorChords[1]
  },
  Phrygian: {
    formula: ["1", "b2", "b3", "4", "5", "b6", "b7"],
    degree: [0, 1, 3, 5, 7, 8, 10],
    name: "Phrygian",
    chords: majorChords[2]
  },
  Lydian: {
    formula: ["1", "2", "3", "#4", "5", "6", "7"],
    degree: [0, 2, 4, 6, 7, 9, 11],
    name: "Lydian",
    chords: majorChords[3]
  },
  Mixolydian: {
    formula: ["1", "2", "3", "4", "5", "6", "b7"],
    degree: [0, 2, 4, 5, 7, 9, 10],
    name: "Mixolydian",
    chords: majorChords[4]
  },
  Aeolian: {
    formula: ["1", "2", "b3", "4", "5", "b6", "b7"],
    degree: [0, 2, 3, 5, 7, 8, 10],
    name: "Aeolian",
    chords: majorChords[5]
  },
  Locrian: {
    formula: ["1", "b2", "b3", "4", "b5", "b6", "b7"],
    degree: [0, 1, 3, 5, 6, 8, 10],
    name: "Locrian",
    chords: majorChords[6]
  }
};
//Harmonic Minor
let harmonicMinorChords = chordPermutations(["min/maj7", "dim b7", "maj7#5", "min7", "dom7", "maj7", "dim 7"]);
export const HarmonicObj = {
  Harmonic: {
    formula: ["1", "2", "b3", "4", "5", "b6", "7"],
    degree: [0, 2, 3, 5, 7, 8, 11],
    name: "Harmonic Minor",
    chords: harmonicMinorChords[0]
  },
  LocrianNat6: {
    formula: ["1", "b2", "b3", "4", "b5", "6", "b7"],
    degree: [0, 1, 3, 5, 6, 9, 10],
    name: "Locrian ♮6",
    chords: harmonicMinorChords[1]
  },
  IonianSharp5: {
    formula: ["1", "2", "3", "4", "#5", "6", "7"],
    degree: [0, 2, 4, 5, 8, 9, 11],
    name: "Ionian #5",
    chords: harmonicMinorChords[2]
  },
  DorianSharp4: {
    formula: ["1", "2", "b3", "#4", "5", "6", "b7"],
    degree: [0, 2, 3, 6, 7, 9, 10],
    name: "Dorian #4",
    chords: harmonicMinorChords[3]
  },
  PhrygianNat3: {
    formula: ["1", "b2", "3", "4", "5", "b6", "b7"],
    degree: [0, 1, 4, 5, 7, 8, 10],
    name: "Phrygian ♮3",
    chords: harmonicMinorChords[4]
  },
  LydianSharp2: {
    formula: ["1", "#2", "3", "#4", "5", "6", "7"],
    degree: [0, 3, 4, 6, 7, 9, 11],
    name: "Lydian #2",
    chords: harmonicMinorChords[5]
  },
  Locrianb4Alt7: {
    formula: ["1", "b2", "b3", "b4", "b5", "b6", "bb7"],
    degree: [0, 1, 3, 4, 6, 8, 9],
    name: "Locrian b4 bb7",
    chords: harmonicMinorChords[6]
  }
};
...
const HalfWhole = [["1", "b2", "b3", "3", "#4", "5", "6", "b7"], [0, 1, 3, 4, 6, 7, 9, 10], "Half Whole Diminished", neapolitanMinorChords[1]];
const WholeHalf = [["1", "2", "b3", "4", "b5", "b6", "6", "7"], [0, 2, 3, 5, 6, 8, 9, 11], "Whole Half Diminished", neapolitanMinorChords[1]];
...
export const Scales = [Major, HarmonicMinor, MelodicMinor, HarmonicMajor, HungarianMajor, HungarianMinor, NeapolitanMinor, NeapolitanMajor, BebopDominant, Hirojoshi, Kumoi, Pentatonic, WholeTone];
